...
const Landing = ({setSelectedPage}) => {
    ...
    return (
        ...
        md:h-full gap-16 py-10">
            {/* Image is the first section, because
            here when we're making a responsive layout,
            we want the picture to be on top of the home section(in mobile size)
            and on right part of the home section(in desktop size). That's why
            we use md:order-2 */}
            {/* IMAGE SECTION */}
            <div className="md:order-2 flex justify-center baseis-3/5 z-10 mt-16
            md:mt-32">
            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                ...
                >
                    <p className="text-6xl font-playfair z-10 text-center md:text-start">
                        Jane {""}
                        <span
                            // We use xs:before:content-brush to add images to the content 
                            // of a before tag.
                    ...
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Saepe doloremque 
                    dolores natus! Similique illum perferendis accusamus dolores!
                    </p>
                </motion.div>
